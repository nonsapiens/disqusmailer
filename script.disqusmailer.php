...
class Com_disqusmailerInstallerScript
{
		...
		<table class="pure-table pure-table-striped">
			<thead>
				<tr>
					...
					<th><?php echo JText::_('DISQUS Status'); ?></th>
				</tr>
			</thead>
			<tfoot>
				<tr>
			...
			<tbody>
				<tr>
					<td colspan="2"><?php echo JText::_('DISQUS Mailer Component'); ?></td>
					<td><strong><?php echo JText::_('Installed'); ?></strong></td>
				</tr>
				<?php if (count($status->plugins)): ?>
				<tr>
					<td><?php echo JText::_('Plugin'); ?></td>
					<td><?php echo JText::_('Group'); ?></td>
					<td></td>
				</tr>
	...
	private function uninstallationResults($status)
	{
		...
		<table class="pure-table pure-table-striped">
			<thead>
				<tr>
					<th colspan="2"><?php echo JText::_('Extensions'); ?></th>
			...
			<tbody>
				<tr>
					<td colspan="2"><?php echo JText::_('Component'); ?></td>
